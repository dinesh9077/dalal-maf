...
Route::prefix('/admin')->group(function () {
  Route::get('/get-areas', 'BackEnd\Property\AreaController@getAreas')->name('admin.property_specification.get_areas')->prefix('property-specification');
  Route::get('/get-location-by-area', 'BackEnd\Property\AreaController@getLocationByArea')->name('admin.property_specification.get_location_by_area'); 
});
...
Route::prefix('/admin')->middleware('auth:admin')->group(function () {
  ...
  //Accounting module
  Route::get('/sales-bill/index', 'BackEnd\AccountController@salesBillListing')->name('admin.sales-bill.index');
  Route::get('/accounting', 'BackEnd\AccountController@index')->name('admin.accounting');
  Route::post('/sales/bill/store', 'BackEnd\AccountController@salesBillStore')->name('admin.account.sales-bill.store');
  Route::get('/account/sales-bill/customer-details/{customer_id}', 'BackEnd\AccountController@customerDetails')->name('account.sales-bill.customer.details');
  Route::post('/account/sales-bill/item/{count}', 'BackEnd\AccountController@salesBillItem')->name('account.sales-bill.item');
  Route::get('/account/sales-bill/invoice-view/{id}', 'BackEnd\AccountController@salesBillInvoiceView')->name('account.invoice.view');
  Route::get('/account/sales-bill/export/{id}', 'BackEnd\AccountController@salesBillExport')->name('account.invoice.export');
  Route::get('/account/sales-bill/record-payment/{id}', 'BackEnd\AccountController@salesBillPayment')->name('account.record.payment');
  Route::post('/account/sales-bill/record-payment-store', 'BackEnd\AccountController@purchaseBillPaymentStore')->name('account.record.payment.store');
  Route::get('/account/sales-bill/record-view-payment/{id}', 'BackEnd\AccountController@salesBillViewPayment')->name('account.record.view.payment');
  Route::get('/account/sales-bill/edit/{id}', 'BackEnd\AccountController@salesBillEdit')->name('account.sales-bill.edit');
  Route::post('/account/sales-bill/update/{id}', 'BackEnd\AccountController@salesBillUpdate')->name('admin.account.sales-bill.update');
  Route::post('/account/sales-bill/delete/{id}', 'BackEnd\AccountController@salesBillDelete')->name('account.sales-bill.delete');
  Route::post('/account/sales-bill/stop-recurring/{id}', 'BackEnd\AccountController@salesBillStopRecurring')->name('account.sales-bill.stop.recurring');
  ...
  Route::prefix('unit-type')->group(function () {
    Route::get('/add', 'BackEnd\Property\PropertyController@unitTypeAdd')->name('admin.unit_type.add');
    Route::post('/store', 'BackEnd\Property\PropertyController@unitTypeStore')->name('admin.unit_type.store');
  });
  ...
  Route::prefix('property-specification')->group(function () {
    ...
    // property area route
    Route::get('/areas', 'BackEnd\Property\AreaController@index')->name('admin.property_specification.areas');
    Route::post('/store-area', 'BackEnd\Property\AreaController@store')->name('admin.property_specification.store_area');
    Route::post('/update-area', 'BackEnd\Property\AreaController@update')->name('admin.property_specification.update_area');
    Route::post('/delete-area', 'BackEnd\Property\AreaController@destroy')->name('admin.property_specification.delete_area');
    Route::post('/bulk-delete-area', 'BackEnd\Property\AreaController@bulkDestroy')->name('admin.property_specification.bulk_delete_area');
  ...
  Route::prefix('property-inventory')->group(function () {
    Route::get('/settings', 'BackEnd\Property\PropertyController@propertSettings')->name('admin.property_inventory.settings');
    Route::get('/properties', 'BackEnd\Property\PropertyController@index')->name('admin.property_inventory.properties');
    Route::get('/type', 'BackEnd\Property\PropertyController@type')->name('admin.property_inventory.type');
    Route::get('/create', 'BackEnd\Property\PropertyController@create')->name('admin.property_inventory.create_property');
    Route::get('/get-agent', 'BackEnd\Property\PropertyController@getAgent')->name('admin.property_inventory.get_agent');
    Route::post('/store', 'BackEnd\Property\PropertyController@store')->name('admin.property_inventory.store_property')->middleware('AdminCheckVendorPackage:property,store');
    Route::post('/update_featured', 'BackEnd\Property\PropertyController@updateFeatured')->name('admin.property_inventory.update_featured');
    Route::post('update_status', 'BackEnd\Property\PropertyController@updateStatus')->name('admin.property_inventory.update_status');
    Route::post('approve-status', 'BackEnd\Property\PropertyController@approveStatus')->name('admin.property_inventory.approve_status');
    Route::get('edit-property/{id}', 'BackEnd\Property\PropertyController@edit')->name('admin.property_inventory.edit');
    Route::post('update/{id}', 'BackEnd\Property\PropertyController@update')->name('admin.property_inventory.update_property')->middleware('AdminCheckVendorPackage:property,update');
    Route::post('specification/delete', 'BackEnd\Property\PropertyController@specificationDelete')->name('admin.property_inventory.specification_delete');
    Route::post('/featured-payment', 'BackEnd\Property\PropertyController@featuredPayment')->name('admin.property_inventory.featured_payment');

    Route::get('/view/{id}', 'BackEnd\Property\PropertyController@view')->name('admin.property_inventory.view');
    Route::get('/wings/{property_id}', 'BackEnd\Property\PropertyController@propertyFullWings')->name('admin.property_inventory.wings');
    Route::post('/wings/store', 'BackEnd\Property\PropertyController@propertyFullWingsStore')->name('admin.property_inventory.wings.store');
    Route::post('/wings/floors', 'BackEnd\Property\PropertyController@propertyFullWingsFloors')->name('admin.property_inventory.wings-floors');
    Route::post('/wing/delete', 'BackEnd\Property\PropertyController@propertyFullWingDelete')->name('admin.property_inventory.wing-delete');
    Route::post('/floors/store', 'BackEnd\Property\PropertyController@propertyFullFloorsStore')->name('admin.property_inventory.floor.store');
    Route::post('/floors/partial', 'BackEnd\Property\PropertyController@propertyFullFloorsPartial')->name('admin.property_inventory.floor.partial');
    Route::post('/floor/delete', 'BackEnd\Property\PropertyController@propertyFullFloorDelete')->name('admin.property_inventory.floor.delete');
    Route::post('/copy/floors/{floor_id}', 'BackEnd\Property\PropertyController@propertyFloorCopy')->name('admin.property_inventory.copy.floor');
    Route::post('/flat/store', 'BackEnd\Property\PropertyController@propertyFullFlatStore')->name('admin.property_inventory.flat.store');
    Route::post('/flat/delete', 'BackEnd\Property\PropertyController@propertyFullFlatDelete')->name('admin.property_inventory.flat.delete');
    Route::post('/floor/status/change', 'BackEnd\Property\PropertyController@propertyFloorStatusChanges')->name('admin.property_inventory.floor.status_change');
    Route::post('/floor/status/store', 'BackEnd\Property\PropertyController@propertyWorkAssignStore')->name('admin.property_inventory.floor.status_store');
    Route::post('/add/customer', 'BackEnd\Property\PropertyController@addCustomer')->name('admin.property_inventory.add.customer');
    Route::get('/manage/status', 'BackEnd\Property\PropertyController@manageStatus')->name('admin.property_inventory.manage_status_property');
    Route::get('/converted/customer', 'BackEnd\Property\PropertyController@convertedCustomer')->name('admin.property_inventory.converted_customer');
    Route::get('/status/property-wing/{property_id}', 'BackEnd\Property\PropertyController@propertyByPropertyWing')->name('admin.manage.status.property.wings');
    Route::post('/property-floor-details', 'BackEnd\Property\PropertyController@propertyByFloorDetails')->name('admin.manage_status_property.property-floor-details');
    ...
    Route::post('delete', 'BackEnd\Property\PropertyController@delete')->name('admin.property_inventory.delete_property');
    Route::post('bulk-delete', 'BackEnd\Property\PropertyController@bulkDelete')->name('admin.property_inventory.bulk_delete_property');
  });
  ...
  Route::post('/change/status', 'BackEnd\Property\PropertyMessageController@changeStatus')->name('admin.inquiry.change_status');


  //inquiry status

  Route::get('/inquiry-status', 'BackEnd\Property\InquiryStatusController@index')->name('admin.status.index');
  Route::post('/admin/store-status', 'BackEnd\Property\InquiryStatusController@store')->name('admin.inquiry.store_status');
  Route::post('/admin/update-status', 'BackEnd\Property\InquiryStatusController@update')->name('admin.inquiry.update_status');
  Route::post('/inquiry/delete', 'BackEnd\Property\InquiryStatusController@delete')->name('admin.inquiry.delete_status');
  Route::post('/inquiry/bulk-delete', 'BackEnd\Property\InquiryStatusController@bulkDelete')->name('admin.inquiry.bulk_delete_status');
  ...
  Route::prefix('/home-page')->middleware('permission:Home Page')->group(function () {
    ...
    Route::prefix('/hero-section')->group(function () {
      ...
      Route::prefix('/static-version')->group(function () {
        ...
        Route::post('/remove-image', 'BackEnd\HomePage\Hero\StaticController@removeImage')->name('admin.home_page.hero_section.static_version.remove_image');
