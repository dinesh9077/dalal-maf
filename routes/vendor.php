...
Route::prefix('vendor')->middleware('auth:vendor')->group(function () {
  Route::post('/become-a-vendor', 'Vendor\VendorController@submitVendorKyc')->name('become-a-vendor');
  Route::get('/kyc', 'Vendor\VendorController@add_kyc')->name('vendor.kyc');
});
Route::prefix('vendor')->middleware('auth:vendor', 'Deactive')->group(function () {
  ...
  Route::post('/phone/resend-otp', 'Vendor\VendorController@resendPhoneOtp')->name('vendor.phone.resend-otp');
  ...
  Route::middleware('vendorHasPackage')->group(function () {
    ...
    Route::prefix('unit-type')->group(function () {
      Route::get('/add', 'Vendor\PropertyController@unitTypeAdd')->name('vendor.unit_type.add');
      Route::post('/store', 'Vendor\PropertyController@unitTypeStore')->name('vendor.unit_type.store');
    });
    ...
    Route::prefix('property-management')->group(function () {
      ...
      Route::post('bulk-delete', 'Vendor\PropertyController@bulkDelete')->name('vendor.property_management.bulk_delete_property');
       Route::get('/get-areas', 'Vendor\PropertyController@getAreas')->name('vendor.property_specification.get_areas');
    ...
    Route::prefix('property-inventory')->group(function () {
      Route::get('/settings', 'Vendor\PropertyController@propertSettings')->name('vendor.property_inventory.settings');
      Route::get('/properties', 'Vendor\PropertyController@index')->name('vendor.property_inventory.properties');
      Route::get('/type', 'Vendor\PropertyController@type')->name('vendor.property_inventory.type');
      Route::get('/create', 'Vendor\PropertyController@create')->name('vendor.property_inventory.create_property');
      Route::get('/get-agent', 'Vendor\PropertyController@getAgent')->name('vendor.property_inventory.get_agent');
      Route::post('/store', 'Vendor\PropertyController@store')->name('vendor.property_inventory.store_property')->middleware('packageLimitsCheck:property,store');
      Route::post('/update_featured', 'Vendor\PropertyController@updateFeatured')->name('vendor.property_inventory.update_featured');
      Route::post('update_status', 'Vendor\PropertyController@updateStatus')->name('vendor.property_inventory.update_status');
      Route::post('approve-status', 'Vendor\PropertyController@approveStatus')->name('vendor.property_inventory.approve_status');
      Route::get('edit-property/{id}', 'Vendor\PropertyController@edit')->name('vendor.property_inventory.edit');
      Route::post('update/{id}', 'Vendor\PropertyController@update')->name('vendor.property_inventory.update_property')->middleware('packageLimitsCheck:property,update');
      Route::post('specification/delete', 'Vendor\PropertyController@specificationDelete')->name('vendor.property_inventory.specification_delete');
      Route::post('/featured-payment', 'Vendor\PropertyController@featuredPayment')->name('vendor.property_inventory.featured_payment');

      Route::get('/view/{id}', 'Vendor\PropertyController@view')->name('vendor.property_inventory.view');
      Route::get('/wings/{property_id}', 'Vendor\PropertyController@propertyFullWings')->name('vendor.property_inventory.wings');
      Route::post('/wings/store', 'Vendor\PropertyController@propertyFullWingsStore')->name('vendor.property_inventory.wings.store');
      Route::post('/wings/floors', 'Vendor\PropertyController@propertyFullWingsFloors')->name('vendor.property_inventory.wings-floors');
      Route::post('/wing/delete', 'Vendor\PropertyController@propertyFullWingDelete')->name('vendor.property_inventory.wing-delete');
      Route::post('/floors/store', 'Vendor\PropertyController@propertyFullFloorsStore')->name('vendor.property_inventory.floor.store');
      Route::post('/floors/partial', 'Vendor\PropertyController@propertyFullFloorsPartial')->name('vendor.property_inventory.floor.partial');
      Route::post('/floor/delete', 'Vendor\PropertyController@propertyFullFloorDelete')->name('vendor.property_inventory.floor.delete');
      Route::post('/copy/floors/{floor_id}', 'Vendor\PropertyController@propertyFloorCopy')->name('vendor.property_inventory.copy.floor');
      Route::post('/flat/store', 'Vendor\PropertyController@propertyFullFlatStore')->name('vendor.property_inventory.flat.store');
      Route::post('/flat/delete', 'Vendor\PropertyController@propertyFullFlatDelete')->name('vendor.property_inventory.flat.delete');
      Route::post('/floor/status/change', 'Vendor\PropertyController@propertyFloorStatusChanges')->name('vendor.property_inventory.floor.status_change');
      Route::post('/floor/status/store', 'Vendor\PropertyController@propertyWorkAssignStore')->name('vendor.property_inventory.floor.status_store');
      Route::post('/add/customer', 'Vendor\PropertyController@addCustomer')->name('vendor.property_inventory.add.customer');
      Route::get('/manage/status', 'Vendor\PropertyController@manageStatus')->name('vendor.property_inventory.manage_status_property');
      Route::get('/status/property-wing/{property_id}', 'Vendor\PropertyController@propertyByPropertyWing')->name('vendor.manage.status.property.wings');
      Route::post('/property-floor-details', 'Vendor\PropertyController@propertyByFloorDetails')->name('vendor.manage_status_property.property-floor-details');
      Route::get('/converted/customer', 'Vendor\PropertyController@convertedCustomer')->name('vendor.property_inventory.converted_customer');
      //#========== Property slider image
      // Route::post('/img-store', 'Vendor\PropertyController@imagesstore')->name('vendor.property.imagesstore')->middleware('packageLimitsCheck:property,store');
      // Route::post('/img-update', 'Vendor\PropertyController@imagesstore')->name('vendor.property.imagesupdate')->middleware('packageLimitsCheck:property,update');
      // Route::post('/img-remove', 'Vendor\PropertyController@imagermv')->name('vendor.property.imagermv');
      ...
      Route::post('delete', 'Vendor\PropertyController@delete')->name('vendor.property_inventory.delete_property');
      Route::post('bulk-delete', 'Vendor\PropertyController@bulkDelete')->name('vendor.property_inventory.bulk_delete_property');
    });

    // customer Management
    Route::prefix('customer-management')->group(function () {
      Route::get('/', 'Vendor\AccountController@customerList')->name('vendor.customer_management.list');
    });
    ...
    Route::get('/sent/inquiry', 'Vendor\PropertyMessageController@sentInquiry')->name('vendor.inquiry.index');
    Route::get('/wishlist', 'Vendor\PropertyMessageController@wishlist')->name('vendor.wishlist');
    ...
    Route::get('/sales-bill/index', 'Vendor\AccountController@salesBillListing')->name('vendor.sales-bill.index');
    Route::get('/accounting', 'Vendor\AccountController@index')->name('vendor.accounting');
    Route::post('/sales/bill/store', 'Vendor\AccountController@salesBillStore')->name('account.sales-bill.store');
    Route::get('/account/sales-bill/customer-details/{customer_id}', 'Vendor\AccountController@customerDetails')->name('account.sales-bill.customer.details');
    Route::post('/account/sales-bill/item/{count}', 'Vendor\AccountController@salesBillItem')->name('account.sales-bill.item');
    Route::get('/account/sales-bill/invoice-view/{id}', 'Vendor\AccountController@salesBillInvoiceView')->name('account.invoice.view');
    Route::get('/account/sales-bill/export/{id}', 'Vendor\AccountController@salesBillExport')->name('account.invoice.export');
    Route::get('/account/sales-bill/record-payment/{id}', 'Vendor\AccountController@salesBillPayment')->name('account.record.payment');
    Route::post('/account/sales-bill/record-payment-store', 'Vendor\AccountController@purchaseBillPaymentStore')->name('account.record.payment.store');
    Route::get('/account/sales-bill/record-view-payment/{id}', 'Vendor\AccountController@salesBillViewPayment')->name('account.record.view.payment');
    Route::get('/account/sales-bill/edit/{id}', 'Vendor\AccountController@salesBillEdit')->name('account.sales-bill.edit');
    Route::post('/account/sales-bill/update/{id}', 'Vendor\AccountController@salesBillUpdate')->name('account.sales-bill.update');
    Route::post('/account/sales-bill/delete/{id}', 'Vendor\AccountController@salesBillDelete')->name('account.sales-bill.delete');
    Route::post('/account/sales-bill/stop-recurring/{id}', 'Vendor\AccountController@salesBillStopRecurring')->name('account.sales-bill.stop.recurring');
