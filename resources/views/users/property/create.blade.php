            ...
            <li class="nav-item">
                <a href="#">{{ __('Add Porperty') }}
                    @if (request('type') == 'residential')
                        {{ '(Residential)' }}
                    @elseif(request('type') == 'industrial')
                        {{ '(Industrial)' }}
                    @else
                        {{ '(Commercial)' }}
                    @endif
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <form id="carForm" action=" {{ route('user.property_management.store_property') }} "
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center add-property-type">
                                                ...
                                                {{-- <a href="javascript:;" onclick="addUnitType()" class="main-btn add-image-btn add-pro-modal btn btn-sm btn-success"><i class="fas fa-plus-circle"></i>
                                          </a> --}}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select name="furnishing" class="form-control js-example-basic-single2">
...
@section('script')
    <script>
        ...
        var values = "{!! $values !!}";
        var storeUrl =
            "{{ route('user.property.imagesstore') }}";
        var removeUrl = "{{ route('user.property.imagermv') }}";
        var stateUrl = "{{ route('user.property_specification.get_state_cities') }}";
        let cityUrl = "{{ route('user.property_specification.get_cities') }}";
        var galleryImages = {{ 999999 }};
        var unitAddUrl = "";
