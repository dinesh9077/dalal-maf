        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-3 offset-lg-5 mt-2 mt-lg-0 text-right">
              <a href="{{ route('user.support_ticket') }}" class="btn new-blck-btn">{{ __('Back to Lists') }}</a>
            </div>
          </div>
        </div>
        <div class="card-body">
                        ...
                        @if ($user)
                          @if ($user->image != null)
                            <img class="avatar-img rounded-circle"
                               src="{{ asset('assets/img/users/' . $user->image) }}" alt="user-photo">
                          @else
      ...
      <div class="col-lg-6 message-type">
        <div class="card card-round">
          <div class="card-body">
            ...
            <form action="{{ route('user.support_ticket.reply', $ticket->id) }}" id="ajaxform" method="POST"
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" name="file" class="custom-file-input"
                      data-href="{{ route('user.support_ticket.zip_file.upload') }}" name="file" id="zip_file">
              ...
              <div class="form-group">
                <button type="submit" class="btn new-blck-btn">{{ __('Message') }}</button>
              </div>
            </form>
          </div>
        </div>
