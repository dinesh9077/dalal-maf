...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form action="{{ route('user.support_ticket.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" value="{{ Auth::guard('web')->user()->email }}"
          ...
          <div class="card-footer">
            <div class="row">
              <div class="col-12 text-center">
                <button type="submit" class="btn Add-pproperty-button">
                  {{ __('Save') }}
                </button>
              </div>
            </div>
