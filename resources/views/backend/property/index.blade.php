                                ...
                                <div class="row g-2 align-items-center">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg mt-2 mt-md-2 mt-lg-0">
                                        <select name="purpose" class="form-select select2"
                                            ...
                                            <option value="rent" @selected(request()->input('purpose') == 'rent')>{{ __('Rent') }}
                                            </option>
                                            <option value="sell" @selected(request()->input('purpose') == 'sell')>{{ __('Sell') }}
                                            </option>
                                            <option value="buy" @selected(request()->input('purpose') == 'buy')>{{ __('Buy') }}
                                            </option>
                                            <option value="lease" @selected(request()->input('purpose') == 'lease')>{{ __('Lease') }}
                                            </option>
                                            <option value="franchiese" @selected(request()->input('purpose') == 'franchiese')>{{ __('Franchiese') }}
                                            </option>
                                            <option value="business_for_sale" @selected(request()->input('purpose') == 'business_for_sale')>
                                                {{ __('Business For Sale') }}</option>
                                        </select>
                                    </div>
                                                                ...
                                                                <form class="deleteForm d-inline-block p-0 dropdown-item"
                                                                 ...
                                                                 @if(isset($is_properties) && $is_properties)
                                                                    <a class="dropdown-item convertfullproperty"
                                                                        href="{{ route("admin.property_management.convert-full-property", $property->id) }}">
                                                                        <span class="btn-label">
