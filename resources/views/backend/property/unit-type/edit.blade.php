    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content"> 
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Unit Type') }}</h5>
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form"
                    action="{{ route('admin.property_specification.update_unit_type') }}" method="post">
                    @csrf
                    <input type="hidden" id="in_unit_id" name="unit_id">  
                    <div class="form-group">
                        <label for="">{{ __('Unit Type') . '*' }}</label>
                        <input class="form-control" type="text" name="unit_name" id="in_unit_name" required>
                    </div> 
                    <div class="form-group">
