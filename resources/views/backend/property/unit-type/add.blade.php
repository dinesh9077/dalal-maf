	...
	<div class="modal-dialog modal-dialog-centered  ">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="btn-close new-close-btn" data-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark"></i></button>
			</div>
			<form id="unitTypeAddForm" action="{{route('admin.unit_type.store')}}" method="post" enctype="multipart/form-data">
