...
<div class="add-modal-main modal fade" id="add_unittype_modal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered  ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close new-close-btn" data-dismiss="modal" aria-label="Close"><i
                        class="fa-solid fa-xmark"></i></button>
            </div>
            <form id="unitTypeAddForm" action="{{ route('admin.unit_type.store') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control select2" id="status11">
        ...
        $('#unitTypeAddForm').submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('#unitTypeAddForm').find('button.spin-button').removeClass('loading').html(
                    'Save');
                    if (res.status == "error") {
                        ...
                        @endif
                        $('#unit_type').append('<option value="' + res.id + '" selected>' + res.name +
                            '</option>'); 
                    }
                }
            });
