...
<div class="table-responsive">
    <table border="0" cellpadding="0" cellspacing="0" style="width: {{$width}}%; margin: 0 auto;border-radius: 0px;margin-bottom: 50px;border: 1px solid #E6E7EC;background: #fff;">
        <tbody>
            <tr>
