...
<div class="page-content">
	<form method="post" action="{{route('admin.account.sales-bill.store')}}" id="invoice_create_form" enctype="multipart/form-data">
		{{ csrf_field() }}
									...
									<div class="row">
										<div class="col-12">
											<div class="form-group">
												...
												<input class="form-control new-box-shadow" type="text" name="invoice_number" id="invoice_number" value="{{Helper::getAutoInvoiceNumber('invoice')}}">
												<input class="form-control new-box-shadow" type="hidden" name="prefix" value="sale">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
												<label class="modal-label">Invoice Date <span class="text-danger">*</span></label>
												<input class="form-control new-box-shado" type="text" name="invoice_date" id="invoice_date" value="{{date('Y-m-d')}}" readonly style="background-color: transparent  !important;background: transparent  !important;">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
												<label class="modal-label">Payment Due Date <span class="text-danger">*</span></label>
												<input class="form-control new-box-shadow due_datepicker" type="text" name="due_date" id="due_date">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
										...
										<div class="col-lg-6 custom_recurring" style="display:none;">
											<div class="form-group">
												<input class="form-control new-box-shadow" type="text" name="repeat_every_custom" value="1" id="repeat_every_custom">
											</div>
										</div>
										<div class="col-lg-6 custom_recurring" style="display:none;">
											<div class="form-group">
										...
										<div class="col-lg-12 cycles"  style="display:none;">
											<div class="form-group">
												<div class="infinity-sec">
													<input type="number" class="form-control new-box-shadow" name="cycle" id="cycles" value="0" readonly>
				...
				<div class="card-box">
					<div class="top-invoice-main">
						...
						<div class="footer-area">
							<textarea class="form-control new-box-shadow" name="footer_note" rows="2" placeholder="Enter a footer for this invoice (eg. Tax info, Thank you note, etc.)"></textarea>
						</div>
					</div>
				</div>
  ...
  var prefix = '/admin';
	...
	function customerDetails()
	{
     ...
     $("[class^='row_id_']").remove();
		...
		if(customer_id != "")
		{
			$.get("{{url('admin/account/sales-bill/customer-details')}}/"+customer_id,
			function(res)
			{
