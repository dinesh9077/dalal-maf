                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <select name="status" id="" class="select2"
                                                ...
                                                <option value="1"  {{ request()->filled('status') && request()->input('status') == '1' ? 'selected' : '' }}>{{ __('Complete') }}</option>
                                                <option value="0"  {{ request()->filled('status') && request()->input('status') == '0' ? 'selected' : '' }}>{{ __('Under Construction') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="row  g-2 align-items-center">
                                        ...
                                        <div style="margin-right: 10px;" class="mt-2 mt-md-0 mt-lg-0">
                                            ...
                                            <button class="btn btn-danger btn-sm float-right  mr-2 d-none bulk-delete"
                                                data-href="{{ route('admin.project_management.bulk_delete_project') }} " style="padding: 10px 12px;"><i
                                                    class="flaticon-interface-5"></i>
                                                {{ __('Delete') }}</button>
                                        </div>
                                    </div>
