                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning">
                                                {{ __('if you do not select any staff, then this project will be listed under you') }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group agent d-none ">
                                            ...
                                            <p class="text-warning">
                                                {{ __('if you do not select any staff, then this project will be listed under Vendor') }}
                                            </p>
                                        </div>
                                    </div>
