  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="addNextPackageForm" class="btn btn-primary nextPackageBtn">{{ __('Add') }}</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  $(document).ready(function () {
    $('#addNextPackageForm').on('submit', function () {
      $('.nextPackageBtn').prop('disabled', true);
      $('.nextPackageBtn').text('Processing...');

    });

    $('#addNextPackage').on('shown.bs.modal', function () {
      const btn = $('.nextPackageBtn');
