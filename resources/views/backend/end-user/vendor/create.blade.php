...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Add Partner') }}</h4>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-title">{{ __('Add Partner') }}</div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" value="" class="form-control" name="phone"
                                                placeholder="{{ __('Enter Phone') }}" max="10" pattern="\d{10}" id="phone">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="" class="form-control vendor-state"
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="" class="form-control vendor-country"
