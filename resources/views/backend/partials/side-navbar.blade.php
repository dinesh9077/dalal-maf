        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                     ...
                     @elseif (request()->routeIs('admin.property_management.settings')) active
                      @elseif(request()->routeIs('admin.property_management.type')) active @endif">
                        <a data-toggle="collapse" href="#carManagement">
                            ...
                            <p>{{ __('Property Management') }} </p><i class="{{ $add_unread_class }}" style="margin-left: 10px;"><b>{{ $unreadCount != 0 ?  $unreadCount : '' }}</b></i>
                            <span class="caret"></span>
                        </a>
                            ...
                            <ul class="nav nav-collapse">
                                ...
                                <li
                                    ...
                                    <a
                                        ...
                                        <span class="sub-item">{{ __('Manage Properties') }}</span> <i class="{{ $add_unread_class }}" style="margin-left: 10px;"><b>{{ $unreadCount != 0 ?  $unreadCount : '' }}</b></i>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Property Inventory', $rolePermissions)))
                    <li class="nav-item
                     @if (request()->routeIs('admin.property_inventory.create_property')) active
                     @elseif (request()->routeIs('admin.property_inventory.properties')) active
                     @elseif (request()->routeIs('admin.property_inventory.edit')) active
                     @elseif (request()->routeIs('admin.property_inventory.settings')) active
                    @elseif(request()->routeIs('admin.property_inventory.type')) active
                    @elseif(request()->routeIs('admin.property_inventory.manage_status_property')) active
                    @elseif(request()->routeIs('admin.property_inventory.converted_customer')) active @endif">
                        ...
                        <div id="inventoryManagement"
                            class="collapse
                              @if (request()->routeIs('admin.property_inventory.create_property')) show
                              @elseif (request()->routeIs('admin.property_inventory.type')) show
                              @elseif (request()->routeIs('admin.property_inventory.properties')) show
                              @elseif (request()->routeIs('admin.property_inventory.settings')) show
                              @elseif (request()->routeIs('admin.property_inventory.edit')) show
                              @elseif (request()->routeIs('admin.property_inventory.manage_status_property')) show
                              @elseif (request()->routeIs('admin.property_inventory.converted_customer')) show
                              @endif
                              ">
                            <ul class="nav nav-collapse">
                                {{-- <li
                                    class="{{ request()->routeIs('admin.property_inventory.settings') ? 'active' : '' }}">
                                    <a href="{{ route('admin.property_inventory.settings') }}">
                                        <span class="sub-item">{{ __('Settings') }}</span>
                                    </a>
                                </li> --}}
                                <li
                                    class="{{ request()->routeIs('admin.property_inventory.create_property') || request()->routeIs('admin.property_inventory.type') ? 'active' : '' }}">
                                ...
                                <li
                                    class="{{ request()->routeIs('admin.property_inventory.properties') ||
                                    request()->routeIs('admin.property_inventory.edit')
                                        ? 'active'
                                        : '' }}">
                                    <a
                                ...
                                <li
                                    class="{{ request()->routeIs('admin.property_inventory.manage_status_property') ? 'active' : '' }}">
                                    <a href="{{ route('admin.property_inventory.manage_status_property') }}">
                                        <span class="sub-item">{{ __('Manage Inventory Status') }}</span>
                                    </a>
                                </li>
                                <li
                                    class="{{ request()->routeIs('admin.property_inventory.converted_customer') ? 'active' : '' }}">
                          ...
                          @if (request()->routeIs('admin.property_message.index')) show @endif">
                            <ul class="nav nav-collapse">
                                <li class="{{ request()->routeIs('admin.property_message.index') ? 'active' : '' }}">
                                    <a href="{{ route('admin.property_message.index') }}">
                                        <span class="sub-item">{{ 'Property Inquiry' }}</span><i class="{{ $inquiry_unread_class }}" style="margin-left: 10px;"><b>{{ $inquiryUnread != 0 ?  $inquiryUnread : '' }}</b></i>
                                    </a>
                                </li>
                    ...
                    <li
                     ...
                     @elseif (request()->routeIs('admin.project_management.edit')) active @endif">
                        <a data-toggle="collapse" href="#projectManagement">
                            ...
                            <p>{{ __('Project Management') }}</p><i class="{{ $project_unread_class }}" style="margin-left: 10px;"><b>{{ $projectUnread != 0 ?  $projectUnread : '' }}</b></i>
                            <span class="caret"></span>
                        </a>
                            ...
                            class="collapse
                                ...
                                <li
                                    ...
                                    <a
                                        ...
                                        <span class="sub-item">{{ __('Manage Projects') }}</span><i class="{{ $project_unread_class }}" style="margin-left: 10px;"><b>{{ $projectUnread != 0 ?  $projectUnread : '' }}</b></i>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li
                      ...
                      @elseif (request()->routeIs('admin.user_management.mail_for_subscribers')) active @endif">
                        <a data-toggle="collapse" href="#user">
                            ...
                            <p>{{ 'Users Management' }}</p><i class="{{ $user_unread_class }}" style="margin-left: 10px;"><b>{{ $userUnread != 0 ?  $userUnread : '' }}</b></i>
                            <span class="caret"></span>
                        </a>
                                ...
                                <li
                                  ...
                                  active @endif ">
                                    <a href="{{ route('admin.user_management.registered_users') }}">
                                        <span class="sub-item">{{ 'Registered Users' }}</span>  <i class="{{ $user_unread_class }}" style="margin-left: 10px;"><b>{{ $userUnread != 0 ?  $userUnread : '' }}</b></i>
                                    </a>
                            ...
                            <ul class="nav nav-collapse">
                                ...
                                <li
                                    ...
                                    <a href="{{ route('admin.vendor_management.registered_vendor') }}">
                                        <span class="sub-item">{{ 'Registered partners' }}</span><i class="{{ $partner_unread_class }}" style="margin-left: 10px;"><b>{{ $partnerUnread != 0 ?  $partnerUnread : '' }}</b></i>
                                    </a>
                                </li>
                                <li class="@if (request()->routeIs('admin.vendor_management.add_vendor')) active @endif">
                                 ...
                                 <li class="@if (request()->routeIs('admin.vendor_management.vendor_kyc')) active @endif">
                                    <a href="{{ route('admin.vendor_management.vendor_kyc') }}">
                                        <span class="sub-item">{{ 'Partner KYC' }}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
