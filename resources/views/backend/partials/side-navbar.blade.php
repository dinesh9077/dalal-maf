            ...
            <ul class="nav nav-primary">
                ...
                <!-- {{-- start user management --}} -->
                    ...
                    <li class="nav-item @if (request()->routeIs('admin.user_management.registered_users')) active
                        ...
                        <a data-toggle="collapse" href="#user">
                            ...
                            <p>{{ 'Owner' }}</p><i class="{{ $user_unread_class }}" style="margin-left: 10px;"><b>{{ $userUnread != 0 ?  $userUnread : '' }}</b></i>
                            <span class="caret"></span>
                        </a>
                            ...
                            <ul class="nav nav-collapse">
                                <li
                                    ...
                                    <a href="{{ route('admin.user_management.registered_users') }}">
                                        <span class="sub-item">{{ 'Builder ' }}</span> <i class="{{ $user_unread_class }}" style="margin-left: 10px;"><b>{{ $userUnread != 0 ?  $userUnread : '' }}</b></i>
                                    </a>
                ...
                <!-- {{-- start Partner management --}} -->
                    ...
                    <li class="nav-item @if (request()->routeIs('admin.vendor_management.registered_vendor')) active
                        ...
                        <a data-toggle="collapse" href="#vendor">
                            <i class="la flaticon-users"></i>
                            <p>{{ 'Builder' }}</p><i class="{{ $partner_unread_class }}" style="margin-left: 10px;"><b>{{ $partnerUnread != 0 ?  $partnerUnread : '' }}</b></i>
                            <span class="caret"></span>
                        </a>
                ...
                <li
                    ...
                    <a data-toggle="collapse" href="#carManagement">
                        ...
                        <p>{{ __('Properties') }} </p><i class="{{ $add_unread_class }}" style="margin-left: 10px;"><b>{{ $unreadCount != 0 ?  $unreadCount : '' }}</b></i>
                        <span class="caret"></span>
                    </a>
                ...
                <li
                    ...
                    <a data-toggle="collapse" href="#projectManagement">
                        ...
                        <p>{{ __('Projects') }}</p><i class="{{ $project_unread_class }}" style="margin-left: 10px;"><b>{{ $projectUnread != 0 ?  $projectUnread : '' }}</b></i>
                        <span class="caret"></span>
                    </a>
                            ...
                            @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Property Inventory', $rolePermissions)))     
                                <li
                                    ...
                                    <a href="{{ route('admin.property_inventory.type') }}">
                                        <i class="la flaticon-paint-palette"></i> <p >{{ __('Add Full Property') }}</p>
                                    </a>
                                </li>
                                ...
                                <li
                                    ...
                                    <a
                                        ...
                                        <i class="la flaticon-paint-palette"></i> <p >{{ __('Manage Full Property') }}</p>
                                        <i class="{{ $add_unread__inventory_class }}" style="margin-left: 10px;"><b>{{ $unreadCountInventory != 0 ?  $unreadCountInventory : '' }}</b></i>
                                    </a>
                                </li>
                                <li
                                    ...
                                    <a href="{{ route('admin.property_inventory.manage_status_property') }}">
                                        <i class="la flaticon-paint-palette"></i> <p>{{ __('Property Live Status') }}</p>
                                    </a>
                                </li>
                                <li
                                    ...
                                    <a href="{{ route('admin.property_inventory.converted_customer') }}">
                                        <i class="la flaticon-paint-palette"></i> <p >{{ __('Purchased Customers ') }}</p>
                                    </a>
                                </li>
                        @endif
                    ...
                    @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Package Management', $rolePermissions)))
                                <li class="nav-item  {{ request()->routeIs('admin.package.index') ? 'active' : '' }}">
                                    <a href="{{ route('admin.package.index') }}">
                                       <i class="fal fa-receipt"></i>   <p class="sub-item">{{ 'Package Management' }}</p>
                                    </a>
                                </li>                   
                    @endif
                    ...
                    @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Payment Gateways', $rolePermissions)))
                        <li class="nav-item {{ request()->routeIs('admin.payment_gateways.online_gateways') ? 'active' : '' }}">
                                        <a href="{{ route('admin.payment_gateways.online_gateways') }}">
                                            <i class="la flaticon-paypal"></i> <p >{{ 'Online Gateways' }}</p>
                                        </a>
                            </li>

                            <li class="nav-item {{ request()->routeIs('admin.payment_gateways.offline_gateways') ? 'active' : '' }}">
                                        <a href="{{ route('admin.payment_gateways.offline_gateways') }}">
                                            <i class="la flaticon-paypal"></i>  <p>{{ 'Offline Gateways' }}</p>
                                        </a>
                            </li>           
                ...
                <!-- {{-- Start basic settings --}} -->
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.basic_settings.general_settings') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ request()->routeIs('admin.home_page.hero_section.static_version') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.hero_section.static_version', ['language' => $defaultLang->code]) }}">
                                    ...
                                    <li class="nav-item {{ request()->routeIs('admin.basic_settings.social_medias') ? 'active' : '' }}">
