...
@section('content')
    ...
    @else
        <div class="row justify-content-center align-items-center mb-1">
            <div class="col-12">
                <div class="alert border-left  text-dark new-vender-title-border" style="z-index:1 !important;">
    ...
    <div class="row dashboard-items">
        {{-- <div class="col-sm-6 col-md-4 col-lg">
            <a href="{{ route('vendor.property_management.properties', ['language' => $defaultLang->code]) }}">
                <div class="card card-stats card-default card-round new-background-color">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-5">
        ...
        <div class="col-sm-6 col-md-4 col-lg">
            <a href="{{ route('vendor.property_management.properties', ['language' => $defaultLang->code]) }}">
                <div class="card card-stats card-primary card-round new-background-color">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-5">
                                <div class="icon-big text-center">
        ...
        <div class="col-sm-6 col-md-4 col-lg">
            <a href="{{ route('vendor.project_management.projects', ['language' => $defaultLang->code]) }}">
                <div class="card card-stats card-success card-round new-background-color">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-5">
                                <div class="icon-big text-center">
        ...
        @if ($support_status->support_ticket_status == 'active')
            <div class="col-sm-6 col-md-4 col-lg">
                <a href="{{ route('vendor.support_tickets') }}">
                    <div class="card card-stats card-secondary card-round new-background-color">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-5">
                                    <div class="icon-big text-center">
        ...
        @if ($current_package != '[]')
            <div class="col-sm-6 col-md-4 col-lg">
                <a href="{{ route('vendor.payment_log') }}">
                    <div class="card card-stats card-info card-round new-background-color">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-5">
                                    <div class="icon-big text-center">
