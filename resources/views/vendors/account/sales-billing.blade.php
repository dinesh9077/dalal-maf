                                          ...
                                          @foreach ($prtStatus as $status)
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                    ...
                                                    <a href="{{ url('vendor/account/sales-bill/invoice-view', $status->id) }}" class="action-btn">
                                                        <i class="fas fa-eye new-icon-color"></i>
                                                        {{-- <img src="{{ asset('assets/images/custom-images/action-ico3.svg') }}" alt=""> --}}
                                                    </a>

                                                    <a href="{{ url('vendor/account/sales-bill/edit', $status->id) }}" class="action-btn">
                                                    ...
                                                    <a href="javascript:;"
                                                      class="action-btn"
                                                      data-url="{{ url('vendor/account/sales-bill/delete', $status->id) }}?datatable=true"
                                                    ...
                                                    @if($amount_due != 0)
                                                        <a class="action-btn convert-btn record1"
                                                          href="{{ url('vendor/account/sales-bill/record-payment', $status->id) }}"
                                                    ...
                                                    <a class="action-btn convert-btn record2"
                                                      href="{{ url('vendor/account/sales-bill/record-view-payment', $status->id) }}"
                                                    ...
                                                    @if($status->recurring != "0" && $status->recurring_stop == 0)
                                                        <a class="action-btn convert-btn record3"
                                                          href="{{ url('vendor/account/sales-bill/stop-recurring', $status->id) }}"
