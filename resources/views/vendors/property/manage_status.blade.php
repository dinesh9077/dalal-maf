                                                            ...
                                                            <select class="modal-input select2" id="property_id"
                                                                ...
                                                                @foreach ($properties as $property)
                                                                    <option value="{{ $property->id }}">
                                                                        {{ $property->propertyContent->title }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
...
@section('script')
    <script>
        ...
        $('#property_id').change(function() {
            ...
            $.get("{{ url('vendor/property-inventory/status/property-wing') }}/" + property_id, function(res) {
        ...
        $(document).on('change', '#property_wings', function() {
            ...
            $.post("{{route('vendor.manage_status_property.property-floor-details')}}",
            {
                _token: "{{ csrf_token() }}",
                wing_id: wing_id,
