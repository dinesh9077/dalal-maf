                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <form id="carForm" action="{{ route($url, $property->id) }}" method="POST"
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-12 text-center">
                            <button type="submit" id="PropertySubmit" class="btn new-blck-btn">
                                {{ __('Update') }}
                            </button>
                        </div>
                    </div>
...
@section('script')
    <script>
        ...
        let areaUrl = "{{ route('vendor.property_specification.get_areas') }}";
