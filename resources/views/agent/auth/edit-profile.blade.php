                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="tel" value="{{ $agent->phone }}" class="form-control"
                                                    ...
                                                    data-original-phone="{{ $agent->phone }}" disabled>
                                        ...
                                        <div id="accordion" class="mt-5">
                                            @foreach ($languages as $language)
                                                <div class="version">
                                                    ...
                                                    @php
                                                        $agent_info = App\Models\AgentInfo::where(
                                                            'agent_id',
                                                            $agent->id,
                                                        )
...
@section('script')
    ...
    $('#sendOtp').on('click', function() {
        ...
        $.ajax({
            url: '{{ route("agent.phone.send-otp") }}', // Update this route
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                phone: phone
    ...
    $('#verifyOtpBtn').on('click', function() {
        ...
        $.ajax({
            url: '{{ route("agent.phone.verify-otp") }}',
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                phone: phone,
...
(function () {
    ...
    $(document).on('click', '#resendOtp', function () {
        ...
        $.ajax({
            url: '{{ route("agent.phone.resend-otp") }}',
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                phone: phone,
