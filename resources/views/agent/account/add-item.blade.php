...
<tr class="row_id_{{$i}}">
	...
	<td>
		<input name="details[{{$i}}]" id="details_{{$i}}" class="form-control" rows="1" placeholder="Enter Item Description" required style="height: 42px;">
	</td>
	<td>
		<input class="form-control invo_price text-right" data-id="{{$i}}" placeholder="Price" type="text" name="price[{{$i}}]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  value="0" id="price_{{$i}}"  style="height: 42px;">
	</td>
	<td>
		<input class="form-control invo_qty" placeholder="Qnty." type="text" name="quantity[{{$i}}]" value="1" id="qty_{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" readOnly  style="height: 42px;     border-radius: .25rem; background-color : white  !important;   border: 1px solid #ebedf2;">
	</td>
	<td>
    <input type="text" name="unit[{{$i}}]" id="unit_{{$i}}" readOnly  style="height: 42px; width: 100%;
...
<tr class="row_id_{{$i}}">
	...
	<td>
		<input type="text" id="discount_{{$i}}" name="discount[{{$i}}]" value="0" class="form-control invo_discount" style="height: 42px ;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  >
	</td>
