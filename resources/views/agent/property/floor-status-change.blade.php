...
<div class="add-modal-main modal fade" id="property_work_modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="propertyWorkAddForm" action="{{route('agent.property_inventory.floor.status_store')}}" method="post" enctype="multipart/form-data">
...
$(document).ready(function() {
    ...
    $('#addCustomerForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('agent.property_inventory.add.customer') }}", // adjust route
            method: "POST",
            data: $(this).serialize(),
            success: function(res) {
