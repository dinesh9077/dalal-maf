...
@section('content')
    @includeIf('frontend.partials.breadcrumb', [
        ...
        'title' => !empty($pageHeading) ? $pageHeading->vendor_page_title : __('Partners'),
        'subtitle' => !empty($pageHeading) ? $pageHeading->vendor_page_title : __('Partners'),
    ])
                    ...
                    <div class="agent-listing projects-area pb-10">
                        ...
                        <div class="row">
                            @forelse ($all_projects as $project)
                                <div class="col-lg-4 col-sm-6 new-pro-des-blog" data-aos="fade-up" data-aos-delay="100">
                                    <a href="{{ route('frontend.projects.details', ['slug' => $project->slug]) }}">
                                        <div class="card">
                                            <div class="card-img card-img-new-project" style="margin-bottom: 0px;">
