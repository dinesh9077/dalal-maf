               ...
               @php use Illuminate\Support\Str; @endphp
				...
				<div class="more-option mobile-item d-flex align-items-center gap-3">
					...
					<div class="item">
						...
						@else
							<div class="dropdown">
								<button type="button" class="style__postContainerTab" data-bs-toggle="dropdown" aria-expanded="false">
					...
					<div class="item">
						@if ($authType === 'guest')
							<button type="button" class="style__postContainerTab" data-bs-toggle="modal" data-bs-target="#customerPhoneModal" data-action="post_property">
