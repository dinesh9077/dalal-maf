...
@section('content')
    <style>
        .login-new-faq-sec-button:not(.collapsed) {
            ...
            <div class="login-container">
                ...
                <div class="login-right ">
                    <div class="postProperty_mb16__2PNyT">
                        <div class="new-left-title-sale-on">Join DalalMaf today and explore <span
                                class="postProperty_blueColor__3_QsX"> DalalMaf </span> today and explore
                            online faster a smarter way to buy, sell, or rent properties.
                        </div>
                    </div>
                    <span class="postProperty_USPsContainer__m80R2"><span class="postProperty_tickGreen___dOl6"></span><span
                            class="postProperty_USPs__3JtoO">Quick & Easy Signup</span></span>
                    <span class="postProperty_USPsContainer__m80R2"><span class="postProperty_tickGreen___dOl6"></span><span
                            class="postProperty_USPs__3JtoO">Access to verified property listings</span></span>
                    <span class="postProperty_USPsContainer__m80R2"><span class="postProperty_tickGreen___dOl6"></span><span
                            class="postProperty_USPs__3JtoO">Connect directly with buyers, sellers & renters</span><span
                            class="postProperty_star__JryVi">*</span></span>
                    <span class="postProperty_USPsContainer__m80R2"><span class="postProperty_tickGreen___dOl6"></span><span
                            class="postProperty_USPs__3JtoO">Safe and transparent platform</span><span
                            class="postProperty_star__JryVi">*</span></span>
                    <span class="postProperty_USPsContainer__m80R2"><span class="postProperty_tickGreen___dOl6"></span><span
                            class="postProperty_USPs__3JtoO">Get real-time updates and enquiries</span><span
                            class="postProperty_star__JryVi">*</span></span>
                    <img src="https://static.99acres.com/universalapp/img/Desktop_Animation_compress.gif"
                        class="postProperty_ppfTabImg__2WDMp">
                ...
                <div class="login-left " style="padding: 14px 21px;">
                    <div class="new-title-LRP">
                        ...
                        <form action="{{ route('user.signup_submit') }}" method="POST">
                            ...
                            <div class="form-group mb-20 input-box"> 
                                <input type="text" class="form-control" name="phone" placeholder="{{ __('Phone') }}" value="{{ session('login_phone') }}" required> 
                            </div>
                            @error('phone')
                            ...
                            {{-- <div class="password-requirements mb-20" style="font-size: 12px; padding: 10px; background: #f8f9fa; border-radius: 4px; border-left: 3px solid #ddd;">
                                ...
                                <div id="req-length" style="margin: 4px 0; color: #dc3545;">
                                    <i class="fa fa-times-circle"></i> At least 8 characters
                                </div>
                                <div id="req-uppercase" style="margin: 4px 0; color: #dc3545;">
                                    <i class="fa fa-times-circle"></i> One uppercase letter (A-Z)
                                </div>
                                <div id="req-lowercase" style="margin: 4px 0; color: #dc3545;">
                                    <i class="fa fa-times-circle"></i> One lowercase letter (a-z)
                                </div>
                                <div id="req-digit" style="margin: 4px 0; color: #dc3545;">
                                    <i class="fa fa-times-circle"></i> One digit (0-9)
                                </div>
                                <div id="req-special" style="margin: 4px 0; color: #dc3545;">
                            ...
                            @enderror 
                            <div class="form-group mb-20 input-box position-relative"> 
                                <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="{{ __('Confirm Password') }}" required>  
                            ...
                            <div class="mb-20 input-box d-flex" style="gap:20px;">
                                <label class="new-lable-radio">
                                    ...
                                    <div class="radio-box">
                                        <img src="{{ asset('assets/front/images/acrs-imag/builder-1.png') }}"
                                            alt="Builder">
                                ...
                                <label class="new-lable-radio">
                                    ...
                                    <div class="radio-box">
                                        <img src="{{ asset('assets/front/images/acrs-imag/owner-1.png') }}"
                                            alt="Owner">
    ...
    <div class="container">
        ...
        <section class="steps-section">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-12 col-md-4 mb-3 d-flex align-items-stretch">
                    <div class="step-box w-100">
                        <span class="step-icon">
                            ...
                            <img src="{{ asset('assets/front/images/acrs-imag/3.png') }}" alt="Property Details Icon"
                                style="width : 48px;" />
                        </span>
                ...
                <div class="col-12 col-md-4 mb-3 d-flex align-items-stretch">
                    <div class="step-box w-100">
                        <span class="step-icon">
                            <img src="{{ asset('assets/front/images/acrs-imag/2.png') }}" alt="Photos & Videos Icon"
                                style="width : 48px;" />
                        </span>
                ...
                <div class="col-12 col-md-4 mb-3 d-flex align-items-stretch">
                    <div class="step-box w-100">
                        <span class="step-icon">
                            <img src="{{ asset('assets/front/images/acrs-imag/1.png') }}" alt="Pricing & Ownership Icon"
                                style="width : 48px;" />
                        </span>
        ...
        <section class="steps-section property-sign-details">
            <!-- Background Image -->
            <img class="property-bg-img" src="{{ asset('assets/front/images/acrs-imag/property-details-bg.png') }}"
                alt="Building Background">
            <!-- Card Overlay -->
            <div class="property-overlay-card">
                <div class="property-card-title">
                    Dala Maaf is transforming real estate across India. With thousands of listings, trusted agents, and
                    happy
                    users, we make buying, selling, and renting simple and reliable
                </div>
                    ...
                    <div class="resntyl-slider-track">
                        ...
                        <a class="resntyl-sliding-item"
                            ...
                            <div class="resntyl-image-container">
                                <img src="{{ asset('assets/front/images/acrs-imag/resentyle-home.png') }}" alt="Property"
                                    class="resntyl-image" />
                            </div>
                            <div>
                ...
                <div class="Testimonial-section-ace-wrapper">
                    <div class="Testimonial-section-ace-track" id="testimonialSliderTrack">
                        <div class="Testimonial-section-ace-card">
                            ...
                            <p>"Dala Maaf made finding my dream home so easy! The verified listings and quick support saved
                                me a
                        ...
                        <div class="Testimonial-section-ace-card">
                            ...
                            <p>"I’ve connected with trusted agents through Dala Maaf and made a smart investment. Their
                                platform
                        ...
                        <div class="Testimonial-section-ace-card">
                            ...
                            <p>"Searching for rental properties used to be a headache, but Dala Maaf made it seamless. I
                                found
                                the perfect apartment in just a few days!"
                            </p>
                        </div>
                    </div>
                ...
                <div class="accordion login-new-faq-sec-accordion" id="loginNewFaqAccordion">
                    ...
                    <div class="accordion-item login-new-faq-sec-item">
                        <h2 class="accordion-header login-new-faq-sec-header" id="faq1-heading">
                            <button class="accordion-button login-new-faq-sec-button" type="button"
                        ...
                        <div id="faq1" class="accordion-collapse collapse show" aria-labelledby="faq1-heading">
                            <div class="accordion-body login-new-faq-sec-body">
                                Dala Maaf is a trusted real estate platform connecting buyers, sellers, renters, and agents
                                with
                                verified residential and commercial properties across India.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item login-new-faq-sec-item">
                        ...
                        <div id="faq2" class="accordion-collapse collapse show" aria-labelledby="faq2-heading">
                            <div class="accordion-body login-new-faq-sec-body">
                                Simply search for your desired property, filter by location, type, or budget, and connect
                                directly with verified agents or owners.
                    ...
                    <div class="accordion-item login-new-faq-sec-item">
                        <h2 class="accordion-header login-new-faq-sec-header" id="faq3-heading">
                            <button class="accordion-button login-new-faq-sec-button collapsed" type="button"
                        ...
                        <div id="faq3" class="accordion-collapse collapse" aria-labelledby="faq3-heading">
                            <div class="accordion-body login-new-faq-sec-body">
                                Yes! Every property on Dala Maaf is carefully verified to ensure authenticity and
                                transparency.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item login-new-faq-sec-item">
                        ...
                        <div id="faq4" class="accordion-collapse collapse" aria-labelledby="faq4-heading">
                            <div class="accordion-body login-new-faq-sec-body">
                                Absolutely. You can easily create an account, upload property details, and reach thousands
                                of
