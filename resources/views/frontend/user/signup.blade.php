				...
				<div class="new-title-LRP">
					...
					<form action="{{ route('user.signup_submit') }}" method="POST">
						...
						<div class="form-group mb-20 input-box">
							...
							value="{{ session('login_phone') }}" readonly>
...
<section class="steps-section property-sign-details">
	...
	<div class="property-overlay-card">
		<div class="property-card-title">
			Dala Maaf is transforming real estate across India. With thousands of listings, trusted agents, and happy
		...
		<div class="Testimonial-section-ace-wrapper">
			<div class="Testimonial-section-ace-track" id="testimonialSliderTrack">
				<div class="Testimonial-section-ace-card">
					...
					<p>"Dala Maaf made finding my dream home so easy! The verified listings and quick support saved me a
				...
				<div class="Testimonial-section-ace-card">
					...
					<p>"I’ve connected with trusted agents through Dala Maaf and made a smart investment. Their platform
				...
				<div class="Testimonial-section-ace-card">
					...
					<p>"Searching for rental properties used to be a headache, but Dala Maaf made it seamless. I found
		...
		<div class="accordion login-new-faq-sec-accordion" id="loginNewFaqAccordion">
			...
			<div class="accordion-item login-new-faq-sec-item">
				...
				<div id="faq1" class="accordion-collapse collapse show" aria-labelledby="faq1-heading">
					<div class="accordion-body login-new-faq-sec-body">
						Dala Maaf is a trusted real estate platform connecting buyers, sellers, renters, and agents with
			...
			<div class="accordion-item login-new-faq-sec-item">
				<h2 class="accordion-header login-new-faq-sec-header" id="faq2-heading">
					<button class="accordion-button login-new-faq-sec-button" type="button"
					data-bs-toggle="collapse" data-bs-target="#faq2" aria-expanded="true" aria-controls="faq2">
			...
			<div class="accordion-item login-new-faq-sec-item">
				...
				<div id="faq4" class="accordion-collapse collapse" aria-labelledby="faq4-heading">
					<div class="accordion-body login-new-faq-sec-body">
						Absolutely. You can easily create an account, upload property details, and reach thousands of
