...
@section('content')
                            ...
                            <form action="{{ route('frontend.properties') }}" method="get" id="{{ $key }}Form">
                                ...
                                <div class="grid mt-2">
                                    ...
                                    <div class="grid-item home-des-border">
                                        <div class="form-group">
                                            <label for="type_{{ $key }}"
                                                class="icon-end">{{ __('Property Type') }}</label>
                                            <select name="type[]" id="type_{{ $key }}"
                                                data-key="{{ $key }}" class="form-control select2 property_type">
                                    ...
                                    <div class="grid-item home-des-border">
                                        <div class="form-group">
                                            <label for="category_{{ $key }}"
                                                class="icon-end">{{ __('Categories') }}</label>
                                    ...
                                    {{-- <div class="grid-item home-des-border">
                                        ...
                                        <div data-range-value="filterPriceSlider_{{ $key }}_value"
                                            style="margin-bottom: 5px;color: black;font-size: 14px;">
            ...
            <div class="container border-0">
                <div class="row" style="position: relative;">
                    <div class="section-title mb-10 new-titles position-relative aos-init aos-animate" data-aos="fade-up">
                        ...
                        <a href="{{ url('view-all-properties') }}?status_type=is_featured"
                    ...
                    <div style="text-align: center;">
                        <a href="{{ url('view-all-properties') }}?status_type=is_featured"
                            class="vs-btn vs-new-set-btn view-all-mobile" style="padding: 8px 20px;">View All</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container" style="padding-bottom: 15px;">
                <div class="row" style="position: relative;">
                    <div class="section-title mb-10 new-titles" data-aos="fade-up" style="position: relative;">
                        ...
                        <a href="{{ url('view-all-properties') }}?status_type=is_hot"
            ...
            <div class="container">
                <div class="row" style="position: relative;">
                    <div class="section-title  mb-10 new-titles" data-aos="fade-up" style="position: relative;">
                        ...
                        <a href="{{ url('view-all-properties') }}?status_type=is_recommended"
                            class="vs-btn vs-new-set-btn view-all-desktop" style="padding: 8px 20px;">View All</a>
            ...
            <div class="container">
                <div class="row" style="position: relative;">
                    ...
                    <div class="section-title mb-10 new-titles" data-aos="fade-up" style="position: relative;">
                        ...
                        <a href="{{ url('view-all-properties') }}?status_type=is_fast_selling"
                            class="vs-btn vs-new-set-btn view-all-desktop" style="padding: 8px 20px;">
                            View All
                        </a>
                    </div>
        ...
        <section class="product-area popular-product product-1 relative">
            ...
            <div class="container pt-20 pb-20">
                <div>
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title prop-pad new-titles" data-aos="fade-up"
                        ...
                        <div class="col-12 LP_SLider-div">
                            <div class="tab-content" data-aos="fade-up">
                                <div class="row new-padding-width-res " style="position: relative; margin-top : 15px;">
                                    ...
                                    <div style="text-align: center;">
                                        <a href="{{ url('view-all-properties') }}?sort=new"
                                            class="vs-btn vs-new-set-btn view-all-mobile" style="padding: 8px 20px;">View
                                            All</a>
                                    </div>
    ...
    <section class="product-area popular-product product-1 relative">
        <div class="container pt-20 pb-20 ">
            ...
            <div class="row BFS_SLider-div" style="position : relative;">
                ...
                <div style="text-align: center;">
                    <a href="{{ route('frontend.properties', ['property_type' => 'partial', 'sort' => 'latest']) }}"
                        class="vs-btn vs-new-set-btn view-all-mobile" style="padding: 8px 20px;">View All</a>
                </div>
        ...
        <div class="container">
            <div class="row FTP-box">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12  FTP-content">
                    <h6>First-time buyer, investor, or renter? Dala Maaf connects you to trusted properties in prime
                        locations your real estate partner.</h6>
                    <p>Looking for your dream home, the right investment, or the best rental deal? Dala Maaf makes it
                        simple. With thousands of verified listings, expert insights, and user-friendly search options, you
                        can buy, sell, or rent properties with complete confidence.</p>
                    <p>Whether you’re a first-time buyer, an investor, or someone searching for the perfect rental, Dala
                        Maaf connects you to trusted property options across prime locations. It’s more than a platform—it’s
                        your partner in real estate.</p>
                    <div style="margin-top: 20px;">
                        <a href="{{ route('frontend.properties') }}" class="new-find-your-btn">Find Your Perfect Property
                            with Dala
                            Maaf</a>
                    </div>
                </div>
                    ...
                    <div class="aps-slider ">
                        @foreach ($all_proeprty_categories as $category)
                            <div class="new-aps-titles-bag">
                                <a
                                    href="{{ route('frontend.properties', ['category' => $category->categoryContent->name]) }}">
                                    <img src="{{ asset('assets/img/property-category/' . $category->image) }}"
                                        alt="" class="new-images-aps-type mx-auto">
            ...
            <div class="container">
                ...
                <div class="row BSR-main-div">
                    <div class="col-lg-4 b-s-r-div-main">
                        <div class="b-s-r-div ">
                            <img src="{{ asset('assets/front/images/acrs-imag/buy.png') }}" alt=""
                                class="b-s-r-img">
                    ...
                    <div class="col-lg-4 b-s-r-div-main">
                        <div class="b-s-r-div ">
                            <img src="{{ asset('assets/front/images/acrs-imag/rent.png') }}" alt=""
                                class="b-s-r-img">
    ...
    <div class="text-center view-all-desktop">
                                    <a href="{{ route('frontend.vendors') }}" class="vs-btn"
                                        style="padding: 11px 20px;">{{ $vendorInfo->btn_name }}</a>
                                </div>
    @endif
                        </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="new-company-card" data-aos="fade-up">
                                    ...
                                    <div class="company-details">
                                        ...
                                        <div>
                                            <p class="new-fonts-property">{{ count($vendor->properties) }}
                                                {{ __('Properties') }}</p>
                                            <p class="new-fonts-property">{{ count($vendor->agents) }} {{ __('Staffs') }}
                                            </p>
                                            <p class="new-fonts-property">{{ count($vendor->projects) }}
                                                {{ __('Projects') }}</p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 button-res">
                    ...
                    <!-- Desktop Button -->
                    <div class="text-center view-all-desktop">
                        <a href="{{ route('blog') }}" class="vs-btn mb-30" style="padding: 11px 20px;">All Blogs</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 mt-1">
                @foreach ($blogs as $blog)
                    <div class="col-md-4">
                        <div class="blog-card">
                            <img src="{{ asset('assets/img/blogs/' . $blog->image) }}" class="blog-img"
                                alt="Blog Image">
                            <div class="blog-body">
                                <h5 class="blog-title">
                                    {{ \Illuminate\Support\Str::limit(strip_tags($blog->title), 40) }}</h5>
                                <p class="blog-text">{{ \Illuminate\Support\Str::limit(strip_tags($blog->content), 90) }}
                                </p>
                                <a href="{{ route('blog_details', ['slug' => $blog->slug]) }}" class="show-more">Show
                                    More →</a>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.property_type').on('change', function() {
                ...
                const key = $(this).data('key'); // same row key
                const categorySelect = $('#category_' + key);

                let filtered = [];

                // If NOT "all", filter categories by type
                if (selectedType !== "all") {
                ...
                filtered.forEach(cat => {
                    options +=
                        `<option value="${cat.category_content.slug}">${cat.category_content.name}</option>`;
                });

                categorySelect.html(options);

                // Refresh Select2 (if used)
                if (categorySelect.hasClass('select2')) {
