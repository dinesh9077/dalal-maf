                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <button class="nav-link {{ $loop->first ? 'active' : '' }}" data-bs-toggle="tab"
                                data-bs-target="#{{ $key }}" type="button">{{ __($label) }}</button>
                        </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="container">
                <div class="col-12">
                    <div class="section-title text-center mb-40 new-titles" data-aos="fade-up"
                        ...
                        <p class="mt-4">Handpicked and premium listings showcased for you. Explore top-rated homes,
                            offices, and commercial spaces that stand out.</p>
                        <a href="{{ url('properties/is_featured/all') }}" class="vs-btn vs-new-set-btn"
            ...
            <div class="container">
                <div class="col-12">
                    <div class="section-title text-center mb-40 new-titles" data-aos="fade-up"
                        ...
                        <p class="mt-4">Handpicked and premium listings showcased for you. Explore top-rated homes,
                            offices, and commercial spaces that stand out.</p>
                        <a href="{{ url('properties/is_hot/all') }}" class="vs-btn vs-new-set-btn"
                            style="padding: 10px 20px;">View All</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="col-12">
                    <div class="section-title text-center mb-40 new-titles" data-aos="fade-up"
                        ...
                        <p class="mt-4">Handpicked and premium listings showcased for you. Explore top-rated homes,
                            offices, and commercial spaces that stand out.</p>
                        <a href="{{ url('properties/is_fast_selling/all') }}" class="vs-btn vs-new-set-btn"
                            style="padding: 10px 20px;">View All</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title text-center mb-40" data-aos="fade-up">
                    ...
                    <p class="mt-4">Stay updated with the newest property listings. Discover fresh options for buying,
                        selling, or renting in just a few clicks.
                    </p>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title text-center mb-40 aos-init aos-animate" data-aos="fade-up">
                    ...
                    <p class="mt-4">Explore a wide range of businesses up for sale. From retail outlets to commercial
                        setups, find the right opportunity to invest and grow.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="position: relative;">
            <div class="col-12">
                <div class="section-title text-center mb-40 aos-init aos-animate" data-aos="fade-up">
                    ...
                    <p class="mt-4">Join hands with Dala Maaf and become a part of a growing network. Unlock business
                        opportunities with our easy-to-start franchise model.</p>
                </div>
            </div>
...
<section class="why-dlal-dection">
    <div class="container">
        <div class="section-title title-inline mb-40 aos-init aos-animate d-flex justify-content-center"
            style="flex-direction: column;" data-aos="fade-up">
