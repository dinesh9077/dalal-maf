...
@section('content')
    <div class="product-single header-next VD-pages">
        ...
        <div class="container"> 
            <div class="row gx-xl-5" data-aos="fade-up">
                ...
                <div class="VD-title">
                    <div>
                        <h3 class="mb-0">
                            <a href="{{ route('frontend.properties', ['category' => $propertyContent->categoryContent?->slug]) }}"
                                class="PTTs">{{ $propertyContent->title }}
                                <span class="product-category new-pdc-s"> ( {{ $propertyContent->categoryContent?->name }}
                                    )</span>
                            </a>
                        </h3>
                        ...
                        <div class="product-price mt-2">
                            ...
                            <div class="product-location icon-start mo-location-text">
                                <i class="fal fa-map-marker-alt" style="margin-inline-end: 0px;"></i>
                                <span style="color: black; letter-spacing: 0px;">
                    ...
                    <div class="share-link">
                        <a href="#" data-bs-toggle="modal" class="share-btn" data-bs-target="#socialMediaModal">
                            <i class="fal fa-share-alt" style="padding-right: 2px;"></i> <span> Share </span>
                        </a>
                        ...
                        @elseif(Auth::guard('vendor')->check())
                            @php
                                ...
                                $checkWishList = checkWishList($propertyContent->propertyId, $user_id, 'vendor');
                            @endphp
                        @elseif(Auth::guard('agent')->check())
                            @php
                                $user_id = Auth::guard('agent')->user()->id;
                                $checkWishList = checkWishList($propertyContent->propertyId, $user_id, 'agent');
                            @endphp
                        @else
                            @php
                                $checkWishList = false;
                        ...
                        @if (!Auth::guard('vendor')->check() && !Auth::guard('web')->check() && !Auth::guard('agent')->check())
                            <a type="button" data-bs-toggle="modal" data-bs-target="#customerPhoneModal"
                                data-action="wishlist" data-property_id="{{ $propertyContent->propertyId }}" class="share-btn">
                                <i class="fal fa-heart"></i> <span>Wishlist</span>
                            </a>
                        @else
                            <a href="javascript:void(0);"
                            class="btn-wishlist share-btn {{ $checkWishList ? 'wishlist-active' : '' }}"
                            ...
                            <i class="fal fa-heart"></i> <span>Wishlist
                            </span> </a>
                        @endif 
                    </div> 
                </div>
                ...
                <div>
                    <div class="mb-3">
                        ...
                        <div class="row new-pro-images-grid">
                            <div class="{{ $count > 1 ? 'col-md-8' : 'col-md-12' }}">
                            ...
                            <div class="col-md-4 d-grid new-top-pp">
                                <div class="row g-3">
                                    @php
                                        $count = $sliders->count();
                                    @endphp
                                    ...
                                    @if ($count >= 4)
                                        @foreach ($sliders->take(4) as $index => $slider)
                                            <div
                                                ...
                                                @if ($loop->last)
                                                    <div class="new-pro-overlay" data-bs-toggle="modal"
                                                        data-bs-target="#newProImagesSliderModal" style="width: 90%;">View
                                                        All</div>
                                                @endif
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="carousel-inner" style="object-fit: cover; height : 500px;">
                                        @foreach ($sliders as $index => $slider)
                                            <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                                <img src="{{ asset('assets/img/property/slider-images/' . $slider->image) }}"
                                                    class="d-block w-100 new-width-set-rounded"
                                                    alt="Slider Image {{ $index + 1 }}">
                                            </div>
                                        @endforeach
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-xl-9 mt-3">
                        <div class="product-single-details vd-new-shadow-left" data-aos="fade-up">
                            ...
                            <div class=" new-details-bg-white product-desc">
                                <h3 class=" new-title-pps">{{ __('Property Description') }}</h3>
                                    ...
                                    <div class="product-featured ">
                                        ...
                                        <ul class="featured-list list-unstyled p-0 mt-20">
                                            @foreach ($amenities as $amenity)
                                                <li class="d-inline-flex flex-column align-items-center me-3 new-aminities-div"
                                                    style="width: 80px;">
                    ...
                    <div class="col-lg-3 col-xl-3 mt-3 ">
                        <div class="vd-new-shadow-left mb-3"
                            style="display: flex; align-items: center; padding: 12px 0px;" data-aos="fade-up">
                            <div class="user-img">
                                ...
                                <div>
                                     ...
                                     @if (!Auth::guard('vendor')->check() && !Auth::guard('web')->check() && !Auth::guard('agent')->check()) 
                                        <button type="button" class="hover-btn mt-2" data-bs-toggle="modal"
                                            data-bs-target="#customerPhoneModal" data-action="contact_seller">
                                            Contact Seller
                                        </button>
                                    @else
                                        <button type="button" class="hover-btn mt-2" data-bs-toggle="modal"
                                            ...
                                            <div class="modal-content model-width">
                                                ...
                                                <div class="modal-body" style="padding: 25px;">
                                                    ...
                                                    <div class="right-new-user-details">
                                                        ...
                                                        <p class="right-em-ph mt-1">Your Dream Home Is Just a Call Away!
                                                        </p>
                                                    ...
                                                    <form action="{{ route('property_contact') }}" method="POST"
                                                        ...
                                                        <div class="form-group mb-15">
                                                            <input type="text"
                                                                ...
                                                                required value="{{ $authUser->username ?? '' }}"
                                                                style="height:36px;">
                                                            @error('name')
                                                        ...
                                                        <div class="form-group mb-15">
                                                            <textarea name="message" id="message" class="form-control new-right-form-control fc-new"
                                                                placeholder="{{ __('Description') }}..." required style="min-height:100px !important;">{{ old('message') }}</textarea>
                                                            @error('message')
                                                                <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="product-default product-inline mt-20 new-hover">
                                                    ...
                                                    <div class="px-2">
                                                        <h6 class="product-title "><a
                                                                href="{{ route('frontend.property.details', $property->slug) }}"
                                                                style="font-size: 12px;">{{ $property->title }}</a>
                                                        </h6>
...
@section('script')
    <script>
        ...
        @if(request()->has('wishlist'))
            ...
            setTimeout(() => { 
                $('.btn-wishlist[data-id="' + property_id + '"]').trigger('click');
