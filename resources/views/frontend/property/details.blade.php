    ...
    <div class="container">
        ...
        <div class="row gx-xl-5" data-aos="fade-up">
            ...
            <div class="VD-title">
                <div>
                    <h3 class="mb-0">
                        <a href="{{ route('frontend.properties', ['category' => $propertyContent->categoryContent?->slug]) }}" class="PTTs">{{ $propertyContent->title }}
                            <span class="product-category new-pdc-s"> ( {{ $propertyContent->categoryContent?->name }} )</span>
                        </a>
                    </h3>
                ...
                <div class="share-link">
                    <a href="#" data-bs-toggle="modal" class="share-btn"
                    ...
                    <a type="button" data-bs-toggle="modal"
                        data-bs-target="#customerPhoneModal" data-action="login" class="share-btn">
                        ...
                        <div class="col-md-4 d-grid new-top-pp">
                            <div class="row g-3">
                                ...
                                <div class="col-6 {{ $loop->last ? 'overlay-container position-relative' : '' }}">
                                    ...
                                    @if ($loop->last)
                                    <div class="new-pro-overlay" data-bs-toggle="modal"
                                        data-bs-target="#newProImagesSliderModal" style="width: 90%;">View All</div>
                                    @endif
                                </div>
                                @endforeach
                                @endif
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-xl-3 mt-3 " >
                    <div class="vd-new-shadow-left mb-3" style="display: flex;
    align-items: center;
    padding: 12px 0px;" data-aos="fade-up">
                         <div class="user-img">
                                <div class=" new-images-lazy ratio ratio-1-1 rounded-pill">
                                    <img class="lazyload" src="{{ asset('assets/img/blank-user.jpg') }}" data-src="@if (!empty($agent)) {{ $agent->image ? asset('assets/img/agents/' . $agent->image) : asset('assets/img/blank-user.jpg') }}
                                                                @elseif(!empty($vendor))
