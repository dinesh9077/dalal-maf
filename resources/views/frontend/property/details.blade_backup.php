...
@section('content')
<div class="product-single pt-70  border-top header-next">
    ...
    <!-- <div class="container py-5">
      <div class="row g-3 property-grid">

          {{-- Big Image (first slider image) --}}
          <div class="col-lg-7 col-md-12">
              <div class="big-img">
                  @if(isset($sliders[0]))
                      <img src="{{ asset('assets/img/property/slider-images/' . $sliders[0]->image) }}" alt="Big Property">
                  @else
          ...
          {{-- Small Images (next 3 normal + 1 view all) --}}
          <div class="col-lg-5 col-md-12">
              <div class="row g-3">
                  @foreach($sliders->skip(1)->take(3) as $key => $slider)
                      <div class="col-6">
                          <div class="small-img">
                              <img src="{{ asset('assets/img/property/slider-images/' . $slider->image) }}"
                                  alt="Small Property {{ $key + 1 }}">
                          </div>
                      </div>
                  @endforeach

                  {{-- Always last one is "View All" --}}
                  @if($sliders->count() > 4)
                      <div class="col-6">
                          <div class="small-img view-all">
                              <img src="{{ asset('assets/img/property/slider-images/' . $sliders[4]->image) }}" alt="View All">
                              <div class="overlay">
                                  <span>+{{ $sliders->count() - 4 }}</span>
                              </div>
                          </div>
                      </div>
                  @endif
            ...
            <div>
                ...
                <div class="mb-5">
                    <div class="row g-3 new-pro-images-grid">
                        ...
                        <!--                @if($loop->last)-->
                        <!--                    <div class="new-pro-overlay" data-bs-toggle="modal" data-bs-target="#newProImagesSliderModal">-->
                        <!--                        View All-->
                        <!--                    </div>-->
                        <!--                @endif-->
                        <!--            </div>-->
                        ...
                        <div class="col-md-4 d-grid gap-3">
                            <div class="row g-3">
                                ...
                                {{-- Agar 4 ya usse zyada images ho --}}
                                @if($count >= 4)
                                @foreach($sliders->take(4) as $index => $slider)
                                <div class="col-6 {{ $loop->last ? 'overlay-container position-relative' : '' }}">
                                    <img src="{{ asset('assets/img/property/slider-images/' . $slider->image) }}"
                      ...
                      <div class="row g-3">
                          ...
                          <img src="https://picsum.photos/id/1025/400/400"
                              data-bs-toggle="modal" data-bs-target="#newProImagesSingleModal"
                              data-img="https://picsum.photos/id/1025/1000/800" alt="img2">
                          </div>

                          <div class="col-6">
                          <img src="https://picsum.photos/id/1035/400/400"
                              data-bs-toggle="modal" data-bs-target="#newProImagesSingleModal"
                              data-img="https://picsum.photos/id/1035/1000/800" alt="img3">
                          </div>
                          <div class="col-6">
                          <img src="https://picsum.photos/id/1045/400/400"
                              data-bs-toggle="modal" data-bs-target="#newProImagesSingleModal"
                              data-img="https://picsum.photos/id/1045/1000/800" alt="img4">
                          </div>
                          <div class="col-6 overlay-container position-relative">
                          <img src="https://picsum.photos/id/1055/400/400" alt="img5">
                          <div class="new-pro-overlay" data-bs-toggle="modal" data-bs-target="#newProImagesSliderModal">View All</div>
                          </div>
                      </div>
                    </div> --}}
                    </div>
                    ...
                    <!-- Single Image Popup Modal -->
                    <div class="modal fade" id="newProImagesSingleModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <img src="" id="newProImagesModalImage" class="w-100 rounded">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-xl">
                            <div class="modal-content bg-dark">
                                <div id="newProImagesCarousel" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner" style="height: 600px;object-fit: cover;">
                                    ...
                                    <ul class="share-link list-unstyled">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ $checkWishList == false ? route('addto.wishlist', $propertyContent->propertyId) : route('remove.wishlist', $propertyContent->propertyId) }}"
                                                class="btn l-s-btn " data-tooltip="tooltip" data-bs-placement="top"
                        ...
                        <aside class="sidebar-widget-area mb-10" data-aos="fade-up">
                            <div class="widget widget-form radius-md mb-30 new-widgets-color">
                                <div class="user new-users mb-20">
                                    <h1 class="rigt-calss-cs">Contact Saller</h1>
    ...
    <!-- <script>
  const modalImage = document.getElementById("newProImagesModalImage");
  const singleImageModal = document.getElementById("newProImagesSingleModal");

  singleImageModal.addEventListener("show.bs.modal", function(event) {
