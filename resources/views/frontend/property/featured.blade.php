...
<div style="margin-top: 150px ; margin-bottom: 80px;">
  ...
  <div class="container " style="margin-top: 50px;" data-aos="fade-up">
    <div class="row">
      ...
      <div class="col-lg-3">
        <div class=" product-default FPD_div">
          <div class="product-details">
            <div class="product-image-box FPD-box">
              <a href="{{ route('frontend.property.details', ['slug' => $property->slug ?? $property->propertyContent->slug]) }}">
                <img class="lazyload new-images-card FPD-img" src="assets/images/placeholder.png" data-src="{{ asset('assets/img/property/featureds/' . $property->featured_image) }}">
              </a>
              ...
              <a href="{{ $checkWishList == false ? route('addto.wishlist', $property->id) : route('remove.wishlist', $property->id) }}"
                class="btn-wishlist new-heart-btn  {{ $checkWishList == false ? '' : 'wishlist-active' }}" data-tooltip="tooltip"
            ...
            <div class="product-new-div">
              ...
              <h3 class="product-title">
                <a href="{{ route('frontend.property.details', $property->slug ?? $property->propertyContent->slug) }}">{{ Str::limit($property->title ?? $property->propertyContent->title, 20) }}</a>
              </h3>
              ...
              <div class="button-new-add mt-3">
                ...
                <a href="{{ route('frontend.property.details', $property->slug ?? $property->propertyContent->slug) }}" class="VD-arrow"> <i class="fa-solid fa-eye"></i>
                </a>
