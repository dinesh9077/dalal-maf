                ...
                <div class="col-lg-8" >
                    <div class="blog-description mb-40" style="background-color: white;     box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.09); padding : 10px; border-radius : 10px;">
                        <article class="item-single">
                            ...
                            <div class="content">
                                <ul class="info-list">
                                    <li><i class="fal fa-user new-bl-ic-co"></i>{{ $details->author }} </li>
                                    <li><i
                                            class="fal fa-calendar new-bl-ic-co"></i>{{ Carbon\Carbon::parse($details->created_at)->format('d M Y') }}
                                    </li>
                                    <li><a href="{{ route('blog', ['category' => $details->categorySlug]) }}"> <i
                                                class="fal fa-list new-bl-ic-co"></i>
                                ...
                                @foreach ($categories as $category)
                                    <li class="d-flex align-items-center justify-content-between">
                                        <a href="{{ route('blog', ['category' => $category->slug]) }}"><i
                                                class="fal fa-folder new-bl-ic-co-d"></i>
                                            {{ $category->name }}</a>
                        ...
                        <div class="widget widget-post radius-md mb-30 p-3">
                            ...
                            @foreach ($recent_blogs as $blog)
                                <article class="article-item mb-30">
                                    ...
                                    <div class="content">
                                        <ul class="info-list">
                                            <li><i class="fal fa-user new-bl-ic-co-d"></i>{{ $blog->author }}</li>
                                            <li><i class="fal fa-calendar new-bl-ic-co-d"></i>
