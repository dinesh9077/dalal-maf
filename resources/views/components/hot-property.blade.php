...
<div {{ $attributes }} class="hot-properties">
    <div class="PD  mb-0 " style="border-radius: 20px;" {{ $animation ? 'data-aos="fade-up" data-aos-delay="100"' : '' }}>
        ...
        <div style="background : white; box-shadow : 0px 0px 10px rgba(0,0,0,0.09); border-radius : 20px; ">
            ...
            <div class="product-image-box new-img-p-box">
                ...
                <span
                    class="HP-lables">{{ $property->purpose === 'sell' ? 'Buy' : ucwords(str_replace('_', ' ', $property->purpose)) }}</span>
                ...
                <div class="product-new-div PND" style="    padding: 15px;">
                    ...
                    <ul class="product-info p-0 list-unstyled d-flex  align-items-center" style="gap:0px;">
                        @if (!in_array($property->purpose, ['franchiese', 'business_for_sale']))
                            <li class="icon-start new-badge-product" data-tooltip="tooltip"
                                title="{{ __('Area') }}">
                                <i class="fal fa-vector-square new-icon-color"></i>
                                <span>{{ $property->area }} {{ __('Sqft') }}</span>
                            </li>
                            @if ($property->type == 'residential')
                                <li class="icon-start new-badge-product ms-3" data-tooltip="tooltip"
                                    title="{{ __('Beds') }}">
                    ...
                    <div class="button-new-add" style="    margin-top: 5px;padding-top: 5px;">
                        ...
                        <span class="product-location icon-start " style="color:#091E42 ; font-size : 14px ;">
                            <i class="fal fa-map-marker-alt"
                                style="color:#091E42 ; font-size : 14px  ;     margin-inline-end: 0px;"></i>
