function MenuEditor(e, t) {
  ...
  var l = null,
    ...
    r = null,
    a = n.iconPicker,
    c = ((t = n.listOptions), $("#" + e + "_icon").iconpicker(a));
  function d() {
    i[0].reset(),
  ...
  function u() {
    var e = $("<div>").addClass("btn-group float-right"),
      t = p({ classCss: "btn btn-primary btn-sm btnEdit", text: n.labelEdit }),
      s = p({
    ...
    return e.append(l).append(o).append(r).append(i).append(t).append(s), e;
  }
  function f(e) {
    $("<span>")
  ...
  function h(e, t) {
    if (n.maxLevel < 0) return !0;
    var s = e.find("ul").length;
    return (
      (0 == t.length ? 0 : parseInt(t.parent().data("level")) + 1) + s <=
      n.maxLevel
    );
  }
  s.sortableLists(n.listOptions),
    c.on("change", function (e) {
      i.find("[name=icon]").val(e.icon);
    }),
    s.on("click", ".btnRemove", function (t) {
      if ((t.preventDefault(), confirm(n.textConfirmDelete))) {
        var l = $(this).closest("ul");
        $(this).closest("li").remove();
        var o = !1;
        void 0 !== l.attr("id") && (o = l.attr("id").toString() === e),
          l.children().length ||
            o ||
            (l.prev("div").children(".sortableListsOpener").first().remove(),
            l.remove()),
          MenuEditor.updateButtons(s);
      }
    }),
    s.on("click", ".btnEdit", function (e) {
      e.preventDefault(),
        (function (e) {
          var t = e.data(); 
          $.each(t, function (e, t) {
    ...
    s.on("click", ".btnOut", function (e) {
      ...
      var t = $(this).closest("ul"),
        n = $(this).closest("li");
      n.closest("ul").closest("li").after(n),
        t.children().length <= 0 &&
    ...
    s.on("click", ".btnIn", function (e) {
      ...
      if (!h(t, n)) return !1;
      if (n.length > 0)
        if ((l = n.children("ul")).length > 0) l.append(t);
        else {
          var l = $("<ul>").addClass("pl-0").css("padding-top", "10px");
          n.append(l), l.append(t), n.addClass("sortableListsOpen"), f(n);
        }
    ...
    (this.add = function () {
      ...
      var t = u(),
        n = $("<span>").addClass("txt").text(e.text),
        l = $("<i>").addClass(e.icon),
        o = $("<div>")
          .css({ overflow: "auto" })
          .append(l)
    ...
    (this.setData = function (e) {
      ...
      if (null !== t) {
        ...
        var l = (function e(t, n) {
          ...
          return (
            $.each(t, function (t, s) {
              var n = void 0 !== s.children && $.isArray(s.children),
                i = {
                  text: "",
                  href: "",
                  icon: "empty",
                ...
                r = $.extend({}, s);
              n && delete r.children, $.extend(i, r);
        ...
        o
          ...
          : (l.sortableLists(n.listOptions), (o = !0)),
          MenuEditor.updateButtons(s);
      }
    });
}
  ...
  (e.fn.sortableLists = function (t) {
    var s = e("body").css("position", "relative"),
      ...
      o = e("<" + l.listSelector + " />")
        ...
        .css(l.baseCss)
        .addClass(l.listsClass + " " + l.baseClass),
      i = e("<li />")
        .attr("id", "sortableListsPlaceholder")
        .css(l.placeholderCss)
        .addClass(l.placeholderClass),
      r = e("<li />")
        .attr("id", "sortableListsHint")
        .css(l.hintCss)
        .addClass(l.hintClass),
      a = e("<" + l.listSelector + " />")
        .attr("id", "sortableListsHintWrapper")
        .addClass(l.listsClass + " " + l.hintWrapperClass)
        .css(l.listsCss)
        .css(l.hintWrapperCss),
      c = e("<span />")
        .addClass("sortableListsOpener " + l.opener.openerClass)
        .css(l.opener.openerCss)
        .on("mousedown touchstart", function (t) {
          var s = e(this).closest("li");
          return s.hasClass("sortableListsClosed") ? L(s) : E(s), !1;
        });
    "class" == l.opener.as
      ? c.addClass(l.opener.close)
      : "html" == l.opener.as
      ? c.html(l.opener.close)
    ...
    if (l.opener.active) {
      ...
      e(this)
        ...
        .each(function () {
          var t = e(this);
          t.children(l.listSelector).length &&
    ...
    return this.on("mousedown touchstart", function (t) {
      var s = e(t.target);
      if (
        !(!1 !== d.isDragged || (l.ignoreClass && s.hasClass(l.ignoreClass)))
      ) {
        ...
        n[0] &&
          ...
          (function (t, s, n) {
            ...
            (d.rootEl = {
              ...
              d.cEl.el.addClass("sortableListsCurrent " + l.currElClass),
              s.before(i);
    ...
    function p(t) {
      if (d.isDragged) {
        ...
        "touchmove" === t.type && v(t),
          ...
          n.scrollTop() > d.rootEl.offset.top - 10 && t.clientY < 50
            ? d.upScroll
              ? ((t.pageY = t.pageY - l.scroll),
          ...
          (d.oEl = oEl =
            (function (t, s) {
              ...
              n && ((t -= d.doc.scrollLeft()), (s -= d.doc.scrollTop()));
    ...
    function u(t) {
      var s = d.cEl,
        n = e("#sortableListsHint", d.rootEl.el),
        o = r[0].style,
        i = null,
        a = !1,
        f = e("#sortableListsHintWrapper");
      ("touchend" !== t.type && "touchcancel" !== t.type) || v(t),
        "block" == o.display && n.length && d.isAllowed
          ? ((i = n), (a = !0))
        ...
        s.el.animate(
          ...
          function () {
            !(function (e) {
              var t = e.el[0].style;
              e.el.removeClass(l.currElClass + " sortableListsCurrent"),
                (t.top = "0"),
                (t.left = "0"),
                (t.position = "relative"),
                (t.width = "auto");
              ...
              (o.display = "none"),
              n.remove(),
              f.removeAttr("id").removeClass(l.hintWrapperClass),
    ...
    function b(t, s) {
      if (
        ...
        t.pageX - s.offset().left < l.insertZone)
      ) {
        ...
        var n = s.children(),
          o = s.children(l.listSelector).first();
        if (o.children().first().is("#sortableListsPlaceholder"))
          return void r.css("display", "none");
        o.length ? o.prepend(r) : (n.first().after(r), r.wrap(a)),
          d.oEl && L(s);
      }
      r.css("display", "block"),
        (d.isAllowed = l.isAllowed(d.cEl.el, r, r.parents("li").first()));
    }
    function g(t, s, n) {
      if (
        (e("#sortableListsHintWrapper", d.rootEl.el).length && r.unwrap(),
        !n && t.pageX - s.offset().left > l.insertZone)
      ) {
        var o = s.children(),
          i = s.children(l.listSelector).first();
    ...
    function m(t, s) {
      if (
        ...
        var n = s.children(),
          o = s.children(l.listSelector).last();
        if (o.children().last().is("#sortableListsPlaceholder"))
          return void r.css("display", "none");
        o.length ? n.last().append(r) : (s.append(r), r.wrap(a)), d.oEl && L(s);
      }
      r.css("display", "block"),
        (d.isAllowed = l.isAllowed(d.cEl.el, r, r.parents("li").first()));
    }
    function C(t, s, n) {
      if (
        ...
        var o = s.children(),
          i = s.children(l.listSelector).last();
    ...
    function L(e) {
      e.removeClass("sortableListsClosed").addClass("sortableListsOpen"),
        e.children(l.listSelector).css("display", "block");
      var t = e.children("div").children(".sortableListsOpener").first();
      "html" == l.opener.as
        ? t.html(l.opener.close)
        : "class" == l.opener.as
        ? t.addClass(l.opener.close).removeClass(l.opener.open)
        : t.css("background-image", "url(" + l.opener.close + ")");
    }
    function E(e) {
      e.removeClass("sortableListsOpen").addClass("sortableListsClosed"),
        e.children(l.listSelector).css("display", "none");
      var t = e.children("div").children(".sortableListsOpener").first();
      "html" == l.opener.as
        ? t.html(l.opener.open)
        : "class" == l.opener.as
        ? t.addClass(l.opener.open).removeClass(l.opener.close)
        : t.css("background-image", "url(" + l.opener.open + ")");
    }
    function w() {
      e(l.listSelector, d.rootEl.el).each(function (t) {
        ...
        e(this)
          ...
          .each(function () {
            var s = e(this),
              n = s.data();
            t.push(n);
            var l = s.children("ul,ol").sortableListsToJson();
            l.length > 0 ? (n.children = l) : delete n.children;
          }),
        t
      );
    }),
    ...
    (e.fn.updateButtons = function (t) {
      ...
      0 === s &&
        ...
        e(this).children("li:first").hideButtons(n),
        e(this).children("li:last").hideButtons(l);
    }),
