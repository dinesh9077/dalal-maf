...
******************************************************/
  ...
  ******************************************************/
  ...
  // if ((account_status == 1 && kyc_approved == 1) || secret_login == 1) {
  ...
  if ((account_status == 1) || secret_login == 1) {
    ...
    $.ajaxSetup({
      beforeSend: function (jqXHR, settings) {
        ...
        if (settings.type == 'POST' && status == 0 && settings.url !== kycUrl) {
          ...
          // if(kyc_approved == 0) {
          //   bootnotify('Please submit your KYC Details!', 'Alert', 'warning')
          // } else {
