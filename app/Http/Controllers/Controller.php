...
class Controller extends BaseController
{
  ...
  public function makeInvoice($request, $key, $member, $password = null, $amount, $payment_method, $phone, $base_currency_symbol_position, $base_currency_symbol, $base_currency_text, $order_id, $package_title, $membership)
  {
