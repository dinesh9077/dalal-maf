...
class PropertyController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		$data['is_properties'] = $this->routeName == 'admin.property_inventory.properties' ? false : true;
	...
	public function create(Request $request)
	{
		...
		$information['propertyCategories'] = PropertyCategory::where([['type', $request->type], ['status', 1]])->with([
	...
	public function edit($id)
	{
		...
		$information['propertyCategories'] = PropertyCategory::where([['type', $property->type], ['status', 1]])->with([
			'categoryContent' => function ($q) use ($language) {
				$q->where('language_id', $language->id);
			}
		])->get();
