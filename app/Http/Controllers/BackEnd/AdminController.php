...
class AdminController extends Controller
{
  ...
  public function redirectToDashboard()
  {
    ...
    $information['property'] = Property::count();
    $information['inquiry'] = PropertyContact::count();
    // $information['live_visitors'] = Cache::get('live_visitors_count', 0);
    $information['live_visitors'] = Cache::get('live_visitors_count', 0);
  ...
  public function leave(Request $request)
    ...
    {
        $visitors = Cache::get('visitors', []);
        $id = $request->ip(); // or Auth::id() if logged in
        $visitors[$id] = now()->timestamp;
