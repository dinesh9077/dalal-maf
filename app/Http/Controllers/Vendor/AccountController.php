...
class AccountController extends Controller
{
    ...
    public function salesBillListing()
    {
        ...
        return view('vendors.account.sales-billing', compact('prtStatus'));
    }
    ...
    public function index()
    {
        ...
        $customers = Customer::whereIn('id',$customerIds)->where('vendor_id',$vendorId)->get();

        return view('vendors.account.index',compact('customers'));
    }
    ...
    public function salesBillItem($i,Request $request)
    {
      try{
        ...
        $view = view('vendors.account.add-item',compact('i','accountUnits','propertyStatus'))->render();
    ...
    public function salesBillInvoiceView($id)
    {
        ...
        return view('vendors.account.invoice-view',compact('customer','width','invoice','invoice_items','id','billings'));
      }
      ...
      public function salesBillExport($id)
      {
          ...
          // $pdf = PDF::loadView('vendors.account.export_style_1',compact('customer','invoice','invoice_items','id','width','billings'));

         $pdf = PDF::loadView('vendors.account.export_style_1', compact('customer', 'invoice', 'invoice_items', 'id', 'width', 'billings', 'amount_due_show'))
      ...
      public function salesBillPayment($invoice_id)
      {
          ...
          $view = view('vendors.account.record-payment',compact('invoice_id','saleInvoice','amount_due'))->render();
          return response()->json(['view'=>$view]);
      }
      ...
      public function salesBillViewPayment($invoice_id)
      {
        ...
        $view = view('vendors.account.view-payment',compact('billingInvices','paidInvoice','invoice_id'))->render();
        return response()->json(['view'=>$view]);
      }
      ...
      public function salesBillEdit($invoice_id)
      {
        ...
        return view('vendors.account.edit',compact('saleInvoice','invoiceItems','customers','accountUnits','propertyStatus'));
	 	  }
      ...
      public function customerList()
      {
          ...
          return view('vendors.account.customer', compact('customers'));
      }
}
